  ...
  * [dataset upgrade](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade "dataset upgrade")
...
## In this article
  * [Synopsis](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#synopsis)
  * [Description](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#description)
  * [Options](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#options)
...
## [Description](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#description)
[Plumbing] Upgrade a dataset so it is usable by the current tools.
This does the same as [codeql database upgrade](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/database-upgrade) but works on a raw dataset rather than an entire database.
## [Options](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#options)
### [Primary Options](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#primary-options)
#### [`<dataset>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#dataset)
[Mandatory] Path to the raw QL dataset to upgrade.
#### [`--search-path=<dir>[:<dir>...]`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--search-pathdirdir)
...
#### [`--additional-packs=<dir>[:<dir>...]`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--additional-packsdirdir)
...
(Note: On Windows the path separator is `;`).
#### [`--target-dbscheme=<file>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--target-dbschemefile)
The _target_ dbscheme we want to upgrade to. If this is not given, a maximal upgrade path will be constructed
#### [`--target-sha=<sha>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--target-shasha)
...
#### [`--[no-]allow-downgrades`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--no-allow-downgrades)
Include any relevant downgrades if there are no upgrades
### [Options to control evaluation of upgrade queries](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#options-to-control-evaluation-of-upgrade-queries)
#### [`--[no-]tuple-counting`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--no-tuple-counting)
...
#### [`--timeout=<seconds>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--timeoutseconds)
...
#### [`-j, --threads=<num>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-j---threadsnum)
...
#### [`--[no-]save-cache`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--no-save-cache)
...
#### [`--[no-]expect-discarded-cache`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--no-expect-discarded-cache)
...
#### [`--[no-]keep-full-cache`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--no-keep-full-cache)
...
#### [`--max-disk-cache=<MB>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--max-disk-cachemb)
...
#### [`--min-disk-free=<MB>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--min-disk-freemb)
...
#### [`--min-disk-free-pct=<pct>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--min-disk-free-pctpct)
...
#### [`--external=<pred>=<file.csv>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--externalpredfilecsv)
A CSV file that contains rows for external predicate _< pred>_. Multiple `--external` options can be supplied.
#### [`--xterm-progress=<mode>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--xterm-progressmode)
...
### [Options for controlling outputting of structured evaluator logs](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#options-for-controlling-outputting-of-structured-evaluator-logs)
#### [`--evaluator-log=<file>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--evaluator-logfile)
...
#### [`--evaluator-log-minify`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--evaluator-log-minify)
...
### [Options to control RAM usage of the upgrade process](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#options-to-control-ram-usage-of-the-upgrade-process)
#### [`-M, --ram=<MB>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-m---rammb)
...
### [Common options](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#common-options)
#### [`-h, --help`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-h---help)
Show this help text.
#### [`-J=<opt>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-jopt)
[Advanced] Give option to the JVM running the command.
(Beware that options containing spaces will not be handled correctly.)
#### [`-v, --verbose`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-v---verbose)
Incrementally increase the number of progress messages printed.
#### [`-q, --quiet`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#-q---quiet)
Incrementally decrease the number of progress messages printed.
#### [`--verbosity=<level>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--verbositylevel)
[Advanced] Explicitly set the verbosity level to one of errors, warnings, progress, progress+, progress++, progress+++. Overrides `-v` and `-q`.
#### [`--logdir=<dir>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--logdirdir)
[Advanced] Write detailed logs to one or more files in the given directory, with generated names that include timestamps and the name of the running subcommand.
(To write a log file with a name you have full control over, instead give `--log-to-stderr` and redirect stderr as desired.)
#### [`--common-caches=<dir>`](https://docs.github.com/en/code-security/codeql-cli/codeql-cli-manual/dataset-upgrade#--common-cachesdir)
