...
### [Configuring the runner job](https://docs.github.com/en/actions/use-cases-and-examples/using-containerized-services/creating-redis-service-containers#configuring-the-runner-job)
